...
$must = @('zscript.txt', 'RSBDEFS.txt', 'MAPINFO.txt', 'MODELDEF.txt', 'CVARINFO.txt', 'MENUDEF.txt', 'SNDINFO.txt', 'PARTICLEDEFS.txt', 'SURFACES.txt', 'KEYCONF.txt', 'DAMAGEDEFS.txt', 'VOLUMEDEFS.txt', 'damage/rsb/hole_chip_a.png',
          ...
          'sprites/RSBMA0.png', 'models/bullet/btracer.obj', 'models/bullet/btracer.png', 'sprites/RSCSA0.png', 'sprites/RSSKA0.png', 'sprites/RSMFB0.png', 'models/rocket/rocket.kvx', 'models/rocket/rocket_pal.png', 'models/debris/chunk.png', 'textures/RBVF0001.dds', 'textures/RBVF0064.dds',
