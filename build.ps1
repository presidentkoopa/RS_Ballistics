...
$rootLumps = @('zscript.txt', 'RSBDEFS.txt', 'MAPINFO.txt', 'MODELDEF.txt', 'CVARINFO.txt', 'MENUDEF.txt', 'SNDINFO.txt', 'PARTICLEDEFS.txt', 'SURFACES.txt', 'KEYCONF.txt')
$files = @()
...
foreach ($d in @('models', 'sprites', 'sounds', 'licenses')) {
    $p = Join-Path $root $d
...
$check.Dispose()
$must = @('zscript.txt', 'RSBDEFS.txt', 'MAPINFO.txt', 'MODELDEF.txt', 'CVARINFO.txt', 'MENUDEF.txt', 'SNDINFO.txt', 'PARTICLEDEFS.txt', 'SURFACES.txt', 'KEYCONF.txt',
          ...
          'zscript/rsb/ejecta.zs', 'zscript/rsb/preview.zs', 'zscript/rsb/service.zs', 'zscript/rsb/flamer.zs', 'zscript/rsb/bench.zs', 'zscript/rsb/projectiles.zs', 'zscript/rsb/heat.zs', 'zscript/rsb/trail.zs', 'zscript/rsb/casings.zs',
