...
<!-- BEGIN shot-out lamps (tools/gen_shotout.py) -->

Derived from the IWADs on this machine -- id Software's own lamp textures, darkened and broken
by tools/gen_shotout.py. The owner was asked, 2026-09-18, whether these should keep this repo
public and chose to leave it as it is: heavily altered, tiny, and alongside audio of similar
provenance already here. Recorded so the next person does not have to guess whether it was
noticed -- it was, and it was decided.

- `textures/GRNLITE1_OUT.png` -- GRNLITE1 shot out, generated by tools/gen_shotout.py from the IWAD's own `GRNLITE1` (DOOM2+TNT+PLUTONIA)
- `textures/LITE2_OUT.png` -- LITE2 shot out, generated by tools/gen_shotout.py from the IWAD's own `LITE2` (DOOM)
- `textures/LITE3_OUT.png` -- LITE3 shot out, generated by tools/gen_shotout.py from the IWAD's own `LITE3` (DOOM+DOOM2+TNT+PLUTONIA)
- `textures/LITE4_OUT.png` -- LITE4 shot out, generated by tools/gen_shotout.py from the IWAD's own `LITE4` (DOOM)
- `textures/LITE5_OUT.png` -- LITE5 shot out, generated by tools/gen_shotout.py from the IWAD's own `LITE5` (DOOM+DOOM2+TNT+PLUTONIA)
- `textures/LITE96_OUT.png` -- LITE96 shot out, generated by tools/gen_shotout.py from the IWAD's own `LITE96` (DOOM)
- `textures/LITEBLU1_OUT.png` -- LITEBLU1 shot out, generated by tools/gen_shotout.py from the IWAD's own `LITEBLU1` (DOOM+DOOM2+TNT+PLUTONIA)
- `textures/LITEBLU2_OUT.png` -- LITEBLU2 shot out, generated by tools/gen_shotout.py from the IWAD's own `LITEBLU2` (DOOM)
- `textures/LITEBLU3_OUT.png` -- LITEBLU3 shot out, generated by tools/gen_shotout.py from the IWAD's own `LITEBLU3` (DOOM)
- `textures/LITEBLU4_OUT.png` -- LITEBLU4 shot out, generated by tools/gen_shotout.py from the IWAD's own `LITEBLU4` (DOOM+DOOM2+TNT+PLUTONIA)
- `textures/LITEGRN1_OUT.png` -- LITEGRN1 shot out, generated by tools/gen_shotout.py from the IWAD's own `LITEGRN1` (TNT)
- `textures/LITERED_OUT.png` -- LITERED shot out, generated by tools/gen_shotout.py from the IWAD's own `LITERED` (DOOM)
- `textures/LITERED1_OUT.png` -- LITERED1 shot out, generated by tools/gen_shotout.py from the IWAD's own `LITERED1` (TNT)
- `textures/LITERED2_OUT.png` -- LITERED2 shot out, generated by tools/gen_shotout.py from the IWAD's own `LITERED2` (TNT)
- `textures/LITEYEL1_OUT.png` -- LITEYEL1 shot out, generated by tools/gen_shotout.py from the IWAD's own `LITEYEL1` (TNT)
- `textures/LITEYEL2_OUT.png` -- LITEYEL2 shot out, generated by tools/gen_shotout.py from the IWAD's own `LITEYEL2` (TNT)
- `textures/LITEYEL3_OUT.png` -- LITEYEL3 shot out, generated by tools/gen_shotout.py from the IWAD's own `LITEYEL3` (TNT)
- `textures/TEKLITE_OUT.png` -- TEKLITE shot out, generated by tools/gen_shotout.py from the IWAD's own `TEKLITE` (DOOM2+TNT+PLUTONIA)
- `textures/TEKLITE2_OUT.png` -- TEKLITE2 shot out, generated by tools/gen_shotout.py from the IWAD's own `TEKLITE2` (DOOM2+TNT+PLUTONIA)
- `textures/TLITE6_1_OUT.png` -- TLITE6_1 shot out, generated by tools/gen_shotout.py from the IWAD's own `TLITE6_1` (DOOM+DOOM2+TNT+PLUTONIA)
- `textures/TLITE6_4_OUT.png` -- TLITE6_4 shot out, generated by tools/gen_shotout.py from the IWAD's own `TLITE6_4` (DOOM+DOOM2+TNT+PLUTONIA)
- `textures/TLITE6_5_OUT.png` -- TLITE6_5 shot out, generated by tools/gen_shotout.py from the IWAD's own `TLITE6_5` (DOOM+DOOM2+TNT+PLUTONIA)
- `textures/TLITE6_6_OUT.png` -- TLITE6_6 shot out, generated by tools/gen_shotout.py from the IWAD's own `TLITE6_6` (DOOM+DOOM2+TNT+PLUTONIA)
